...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden selection:bg-primary selection:text-black font-sans">
      ...
      <section
        id="home"
        className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-28 scroll-mt-28"
      >
        <div className="max-w-5xl mx-auto w-full flex flex-col items-start z-10">
          ...
          <Reveal>
            <h1 className="text-5xl md:text-7xl lg:text-[80px] font-bold font-display leading-[1.1] mb-6 text-foreground">
              FULL STACK ENGINEER
              <span className="block text-muted-foreground mt-2">who builds AI products</span>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="border border-border bg-card p-10 h-full hover:border-primary/30 transition-colors">
              ...
              <ul className="space-y-4 font-mono text-sm text-muted-foreground mb-8">
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-secondary" /> React, TypeScript, Node.js
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-secondary" /> Express,SQL, MongoDB, NoSQL
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-secondary" /> REST APIs,
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-secondary" /> Tailwind, Git, Github
                </li>
              </ul>
          ...
          <Reveal delay={0.2}>
            <div className="border border-border bg-card p-10 h-full hover:border-primary/30 transition-colors">
              ...
              <ul className="space-y-4 font-mono text-sm text-muted-foreground mb-8">
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> C, C++, Python (OOP)
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> Data Structures and Algorithms
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> System Design and Architecture
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-primary" /> Database Optimization
                </li>
              </ul>
      ...
      {/* SECTION 6: CONTACT */}
      <section id="contact" className="py-24 px-6 max-w-7xl mx-auto flex flex-col md:flex-row gap-16 relative scroll-mt-28">
        <div className="md:w-1/2 flex flex-col justify-center">
          <Reveal>
            <h2 className="text-4xl md:text-6xl font-display font-bold text-foreground mb-6 leading-tight">
              Let's build something <span className="text-primary text-glow">impactful.</span>
            </h2>
            <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
              If you're looking for a full stack engineer who can ship production-grade software quickly,
              reach out.
            </p>
            ...
            <div className="flex flex-col gap-4 mb-12">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-muted-foreground font-mono">
                    {isCopied ? "Copied!" : "saadkhanmrd33@gmail.com"}
                  </div>
                </div>
              </button>

              <a
                href="https://github.com/SaadMwa"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 border border-border bg-card p-4 hover:border-foreground transition-colors group"
              >
              ...
              <a
                href="https://www.linkedin.com/in/saad-tariq-ab7827336/"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 border border-border bg-card p-4 hover:border-secondary transition-colors group"
              >
        ...
        <div className="md:w-1/2 relative">
          <Reveal delay={0.2}>
            <div className="bg-card border border-border p-8 relative z-10">
              <h3 className="text-2xl font-bold font-display mb-6 border-b border-border pb-4">
